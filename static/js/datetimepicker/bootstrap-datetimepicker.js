...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		this.setDaysOfDisabled(options.daysOfDisabled || this.element.data('date-days-of-disabled'))
		this.fillDow();
		this.fillMonths();
		this.update();
		this.showMode();
	...
	Datetimepicker.prototype = {
		...
		setDaysOfDisabled: function (daysOfDisabled) {
			...
			this.daysOfDisabled = $.map(this.daysOfDisabled, function (d) {
				return DPGlobal.parseDate(d, format, language, formatType).valueOf();
			});
			this.update();
			this.updateNavArrows();
		},
		...
		fill: function () {
			...
			while (prevMonth.valueOf() < nextMonth) {
				...
				if ((prevMonth.valueOf() + 86400000) <= this.startDate || prevMonth.valueOf() > this.endDate ||
					...
					$.inArray(prevMonth.valueOf(), this.daysOfDisabled) !== -1) {
					clsName += ' disabled';
				}
